...
export default class MysApi {
    ...
    getServer() {
        ...
        } else if (this.game == "bh3") {
            switch (_uid.slice(0, 1)) {
                case "1": return "android01" // 安卓官服
                case "2": return "bb01"      // 哔哩哔哩
                case "3": return "yyb01"     // 应用宝服
                case "4": return "hun01"     // 渠道1/2服
                case "5": return "ios01"     // iOS服
                default: return "android01"
            }
        } else {
            switch (_uid.slice(0, -8)) {
                case '5':
